...
//----------------------------------------------------------------------------------------------------------------------------------------------------------------------
	...
	App.TSReceive -> AM.Receive[AM_TS_22];
	App.DataReceive -> AM.Receive[AM_D_22];
	App.TSReceive_Head -> AM.Receive[AM_TS_Head_22];
	App.DataReceive_Head -> AM.Receive[AM_D_Head_22];

...
//----------------------------------------------------------------------------------------------------------------------------------------------------------------------
	...
	App.TSReceive -> AM.Receive[AM_TS_2D];
	App.DataReceive -> AM.Receive[AM_D_2D];
	App.TSReceive_Head -> AM.Receive[AM_TS_Head_2D];
	App.DataReceive_Head -> AM.Receive[AM_D_Head_2D];

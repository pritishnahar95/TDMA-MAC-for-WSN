...
//----------------------------------------------------------------------------------------------------------------------------------------------------------------------
	...
	App.TSReceive -> AM.Receive[AM_TS_2B];
	App.DataReceive -> AM.Receive[AM_D_2B];
	App.TSReceive_Head -> AM.Receive[AM_TS_Head_2B];
	App.DataReceive_Head -> AM.Receive[AM_D_Head_2B];

...
//----------------------------------------------------------------------------------------------------------------------------------------------------------------------
	...
	App.TSReceive -> AM.Receive[AM_TS_28];
	App.DataReceive -> AM.Receive[AM_D_28];
	App.TSReceive_Head -> AM.Receive[AM_TS_Head_28];
	App.DataReceive_Head -> AM.Receive[AM_D_Head_28];

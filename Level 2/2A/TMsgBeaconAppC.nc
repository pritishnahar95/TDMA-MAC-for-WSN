...
//----------------------------------------------------------------------------------------------------------------------------------------------------------------------
	...
	App.TSReceive -> AM.Receive[AM_TS_2A];
	App.DataReceive -> AM.Receive[AM_D_2A];
	App.TSReceive_Head -> AM.Receive[AM_TS_Head_2A];
	App.DataReceive_Head -> AM.Receive[AM_D_Head_2A];

...
//----------------------------------------------------------------------------------------------------------------------------------------------------------------------
	...
	App.TSReceive -> AM.Receive[AM_TS_24];
	App.DataReceive -> AM.Receive[AM_D_24];
	App.TSReceive_Head -> AM.Receive[AM_TS_Head_24];
	App.DataReceive_Head -> AM.Receive[AM_D_Head_24];

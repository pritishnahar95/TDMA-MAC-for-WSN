...
//----------------------------------------------------------------------------------------------------------------------------------------------------------------------
	...
	App.TSReceive -> AM.Receive[AM_TS_27];
	App.DataReceive -> AM.Receive[AM_D_27];
	App.TSReceive_Head -> AM.Receive[AM_TS_Head_27];
	App.DataReceive_Head -> AM.Receive[AM_D_Head_27];

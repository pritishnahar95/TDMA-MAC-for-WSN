...
//----------------------------------------------------------------------------------------------------------------------------------------------------------------------
	...
	App.TSReceive -> AM.Receive[AM_TS_26];
	App.DataReceive -> AM.Receive[AM_D_26];
	App.TSReceive_Head -> AM.Receive[AM_TS_Head_26];
	App.DataReceive_Head -> AM.Receive[AM_D_Head_26];

...
//----------------------------------------------------------------------------------------------------------------------------------------------------------------------
	...
	App.TSReceive -> AM.Receive[AM_TS_25];
	App.DataReceive -> AM.Receive[AM_D_25];
	App.TSReceive_Head -> AM.Receive[AM_TS_Head_25];
	App.DataReceive_Head -> AM.Receive[AM_D_Head_25];

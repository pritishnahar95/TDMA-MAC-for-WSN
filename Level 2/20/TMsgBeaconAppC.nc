...
//----------------------------------------------------------------------------------------------------------------------------------------------------------------------
	...
	App.TSReceive -> AM.Receive[AM_TS_20];
	App.DataReceive -> AM.Receive[AM_D_20];
	App.TSReceive_Head -> AM.Receive[AM_TS_Head_20];
	App.DataReceive_Head -> AM.Receive[AM_D_Head_20];

	App.Send_1 -> AM.AMSend[AM_TS_21];
	...
	App.Send_1_Data -> AM.AMSend[AM_D_21];

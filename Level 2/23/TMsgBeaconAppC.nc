...
//----------------------------------------------------------------------------------------------------------------------------------------------------------------------
	...
	App.TSReceive -> AM.Receive[AM_TS_23];
	App.DataReceive -> AM.Receive[AM_D_23];
	App.TSReceive_Head -> AM.Receive[AM_TS_Head_23];
	App.DataReceive_Head -> AM.Receive[AM_D_Head_23];

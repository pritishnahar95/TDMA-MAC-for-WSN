...
//----------------------------------------------------------------------------------------------------------------------------------------------------------------------
	...
	App.TSReceive -> AM.Receive[AM_TS_2E];
	App.DataReceive -> AM.Receive[AM_D_2E];
	App.TSReceive_Head -> AM.Receive[AM_TS_Head_2E];
	App.DataReceive_Head -> AM.Receive[AM_D_Head_2E];

	App.Send_1 -> AM.AMSend[AM_TS_20];
	App.Send_2 -> AM.AMSend[AM_TS_21];
	App.Send_3 -> AM.AMSend[AM_TS_22];
	App.Send_4 -> AM.AMSend[AM_TS_23];
	App.Send_5 -> AM.AMSend[AM_TS_24];
	App.Send_6 -> AM.AMSend[AM_TS_25];
	App.Send_7 -> AM.AMSend[AM_TS_26];
	App.Send_8 -> AM.AMSend[AM_TS_27];
	App.Send_9 -> AM.AMSend[AM_TS_28];
	App.Send_A -> AM.AMSend[AM_TS_29];
	App.Send_B -> AM.AMSend[AM_TS_2A];
	App.Send_C -> AM.AMSend[AM_TS_2B];
	App.Send_D -> AM.AMSend[AM_TS_2C];
	App.Send_E -> AM.AMSend[AM_TS_2D];

	App.Send_1_Data -> AM.AMSend[AM_D_20];
	App.Send_2_Data -> AM.AMSend[AM_D_21];
	App.Send_3_Data -> AM.AMSend[AM_D_22];
	App.Send_4_Data -> AM.AMSend[AM_D_23];
	App.Send_5_Data -> AM.AMSend[AM_D_24];
	App.Send_6_Data -> AM.AMSend[AM_D_25];
	App.Send_7_Data -> AM.AMSend[AM_D_26];
	App.Send_8_Data -> AM.AMSend[AM_D_27];
	App.Send_9_Data -> AM.AMSend[AM_D_28];
	App.Send_A_Data -> AM.AMSend[AM_D_29];
	App.Send_B_Data -> AM.AMSend[AM_D_2A];
	App.Send_C_Data -> AM.AMSend[AM_D_2B];
	App.Send_D_Data -> AM.AMSend[AM_D_2C];
	App.Send_E_Data -> AM.AMSend[AM_D_2D];

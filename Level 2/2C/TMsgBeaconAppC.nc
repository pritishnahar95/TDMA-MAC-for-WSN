...
//----------------------------------------------------------------------------------------------------------------------------------------------------------------------
	...
	App.TSReceive -> AM.Receive[AM_TS_2C];
	App.DataReceive -> AM.Receive[AM_D_2C];
	App.TSReceive_Head -> AM.Receive[AM_TS_Head_2C];
	App.DataReceive_Head -> AM.Receive[AM_D_Head_2C];

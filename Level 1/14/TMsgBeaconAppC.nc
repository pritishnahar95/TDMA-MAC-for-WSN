...
//----------------------------------------------------------------------------------------------------------------------------------------------------------------------
	...
	App.TSReceive -> AM.Receive[AM_TS_14];
	App.DataReceive -> AM.Receive[AM_D_14];
	App.TSReceive_Head -> AM.Receive[AM_TS_Head_14];
	App.DataReceive_Head -> AM.Receive[AM_D_Head_14];

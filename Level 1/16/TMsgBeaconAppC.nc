...
//----------------------------------------------------------------------------------------------------------------------------------------------------------------------
	...
	App.TSReceive -> AM.Receive[AM_TS_16];
	App.DataReceive -> AM.Receive[AM_D_16];
	App.TSReceive_Head -> AM.Receive[AM_TS_Head_16];
	App.DataReceive_Head -> AM.Receive[AM_D_Head_16];

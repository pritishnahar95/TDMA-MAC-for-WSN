...
//----------------------------------------------------------------------------------------------------------------------------------------------------------------------
	...
	App.TSReceive -> AM.Receive[AM_TS_1B];
	App.DataReceive -> AM.Receive[AM_D_1B];
	App.TSReceive_Head -> AM.Receive[AM_TS_Head_1B];
	App.DataReceive_Head -> AM.Receive[AM_D_Head_1B];

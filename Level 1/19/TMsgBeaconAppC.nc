...
//----------------------------------------------------------------------------------------------------------------------------------------------------------------------
	...
	App.TSReceive -> AM.Receive[AM_TS_19];
	App.DataReceive -> AM.Receive[AM_D_19];
	App.TSReceive_Head -> AM.Receive[AM_TS_Head_19];
	App.DataReceive_Head -> AM.Receive[AM_D_Head_19];

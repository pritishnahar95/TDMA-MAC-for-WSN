...
//----------------------------------------------------------------------------------------------------------------------------------------------------------------------
	...
	App.TSReceive -> AM.Receive[AM_TS_17];
	App.DataReceive -> AM.Receive[AM_D_17];
	App.TSReceive_Head -> AM.Receive[AM_TS_Head_17];
	App.DataReceive_Head -> AM.Receive[AM_D_Head_17];

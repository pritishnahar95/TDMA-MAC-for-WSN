...
//----------------------------------------------------------------------------------------------------------------------------------------------------------------------
	...
	App.TSReceive -> AM.Receive[AM_TS_12];
	App.DataReceive -> AM.Receive[AM_D_12];
	App.TSReceive_Head -> AM.Receive[AM_TS_Head_12];
	App.DataReceive_Head -> AM.Receive[AM_D_Head_12];

...
//----------------------------------------------------------------------------------------------------------------------------------------------------------------------
	...
	App.TSReceive -> AM.Receive[AM_TS_1C];
	App.DataReceive -> AM.Receive[AM_D_1C];
	App.TSReceive_Head -> AM.Receive[AM_TS_Head_1C];
	App.DataReceive_Head -> AM.Receive[AM_D_Head_1C];

...
//----------------------------------------------------------------------------------------------------------------------------------------------------------------------
	...
	App.TSReceive -> AM.Receive[AM_TS_18];
	App.DataReceive -> AM.Receive[AM_D_18];
	App.TSReceive_Head -> AM.Receive[AM_TS_Head_18];
	App.DataReceive_Head -> AM.Receive[AM_D_Head_18];

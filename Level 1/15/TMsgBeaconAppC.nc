...
//----------------------------------------------------------------------------------------------------------------------------------------------------------------------
	...
	App.TSReceive -> AM.Receive[AM_TS_15];
	App.DataReceive -> AM.Receive[AM_D_15];
	App.TSReceive_Head -> AM.Receive[AM_TS_Head_15];
	App.DataReceive_Head -> AM.Receive[AM_D_Head_15];

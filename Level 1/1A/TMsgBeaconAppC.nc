...
//----------------------------------------------------------------------------------------------------------------------------------------------------------------------
	...
	App.TSReceive -> AM.Receive[AM_TS_1A];
	App.DataReceive -> AM.Receive[AM_D_1A];
	App.TSReceive_Head -> AM.Receive[AM_TS_Head_1A];
	App.DataReceive_Head -> AM.Receive[AM_D_Head_1A];

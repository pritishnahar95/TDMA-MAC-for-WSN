...
//----------------------------------------------------------------------------------------------------------------------------------------------------------------------
	...
	App.TSReceive -> AM.Receive[AM_TS_33];
	App.DataReceive -> AM.Receive[AM_D_33];
	App.TSReceive_Head -> AM.Receive[AM_TS_Head_33];
	App.DataReceive_Head -> AM.Receive[AM_D_Head_33];

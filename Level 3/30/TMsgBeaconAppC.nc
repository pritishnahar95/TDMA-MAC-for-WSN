...
//----------------------------------------------------------------------------------------------------------------------------------------------------------------------
	...
	App.TSReceive -> AM.Receive[AM_TS_30];
	App.DataReceive -> AM.Receive[AM_D_30];
	App.TSReceive_Head -> AM.Receive[AM_TS_Head_30];
	App.DataReceive_Head -> AM.Receive[AM_D_Head_30];

	App.Send_1 -> AM.AMSend[AM_TS_31];
	App.Send_2 -> AM.AMSend[AM_TS_32];
	App.Send_3 -> AM.AMSend[AM_TS_33];
	App.Send_4 -> AM.AMSend[AM_TS_34];
	App.Send_5 -> AM.AMSend[AM_TS_35];
	App.Send_6 -> AM.AMSend[AM_TS_36];
	App.Send_7 -> AM.AMSend[AM_TS_37];
	App.Send_8 -> AM.AMSend[AM_TS_38];
	App.Send_9 -> AM.AMSend[AM_TS_39];
	App.Send_A -> AM.AMSend[AM_TS_3A];
	App.Send_B -> AM.AMSend[AM_TS_3B];
	App.Send_C -> AM.AMSend[AM_TS_3C];
	App.Send_D -> AM.AMSend[AM_TS_3D];
	App.Send_E -> AM.AMSend[AM_TS_3E];

	App.Send_1_Data -> AM.AMSend[AM_D_31];
	App.Send_2_Data -> AM.AMSend[AM_D_32];
	App.Send_3_Data -> AM.AMSend[AM_D_33];
	App.Send_4_Data -> AM.AMSend[AM_D_34];
	App.Send_5_Data -> AM.AMSend[AM_D_35];
	App.Send_6_Data -> AM.AMSend[AM_D_36];
	App.Send_7_Data -> AM.AMSend[AM_D_37];
	App.Send_8_Data -> AM.AMSend[AM_D_38];
	App.Send_9_Data -> AM.AMSend[AM_D_39];
	App.Send_A_Data -> AM.AMSend[AM_D_3A];
	App.Send_B_Data -> AM.AMSend[AM_D_3B];
	App.Send_C_Data -> AM.AMSend[AM_D_3C];

...
//----------------------------------------------------------------------------------------------------------------------------------------------------------------------
	...
	App.TSReceive -> AM.Receive[AM_TS_3E];
	App.DataReceive -> AM.Receive[AM_D_3E];
	App.TSReceive_Head -> AM.Receive[AM_TS_Head_3E];
	App.DataReceive_Head -> AM.Receive[AM_D_Head_3E];
	...
	App.Send_D -> AM.AMSend[AM_TS_3C];
	App.Send_E -> AM.AMSend[AM_TS_3D];
	...
	App.Send_D_Data -> AM.AMSend[AM_D_3C];
	App.Send_E_Data -> AM.AMSend[AM_D_3D];

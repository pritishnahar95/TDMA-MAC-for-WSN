...
//----------------------------------------------------------------------------------------------------------------------------------------------------------------------
	...
	App.TSReceive -> AM.Receive[AM_TS_3D];
	App.DataReceive -> AM.Receive[AM_D_3D];
	App.TSReceive_Head -> AM.Receive[AM_TS_Head_3D];
	App.DataReceive_Head -> AM.Receive[AM_D_Head_3D];

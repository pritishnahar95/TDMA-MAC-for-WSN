...
//----------------------------------------------------------------------------------------------------------------------------------------------------------------------
	...
	App.TSReceive -> AM.Receive[AM_TS_35];
	App.DataReceive -> AM.Receive[AM_D_35];
	App.TSReceive_Head -> AM.Receive[AM_TS_Head_35];
	App.DataReceive_Head -> AM.Receive[AM_D_Head_35];

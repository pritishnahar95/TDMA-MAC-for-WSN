...
//----------------------------------------------------------------------------------------------------------------------------------------------------------------------
	...
	App.TSReceive -> AM.Receive[AM_TS_36];
	App.DataReceive -> AM.Receive[AM_D_36];
	App.TSReceive_Head -> AM.Receive[AM_TS_Head_36];
	App.DataReceive_Head -> AM.Receive[AM_D_Head_36];

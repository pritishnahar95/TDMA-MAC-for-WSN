...
//----------------------------------------------------------------------------------------------------------------------------------------------------------------------
	...
	App.TSReceive -> AM.Receive[AM_TS_3B];
	App.DataReceive -> AM.Receive[AM_D_3B];
	App.TSReceive_Head -> AM.Receive[AM_TS_Head_3B];
	App.DataReceive_Head -> AM.Receive[AM_D_Head_3B];

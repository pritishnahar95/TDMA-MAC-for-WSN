...
//----------------------------------------------------------------------------------------------------------------------------------------------------------------------
	...
	App.TSReceive -> AM.Receive[AM_TS_32];
	App.DataReceive -> AM.Receive[AM_D_32];
	App.TSReceive_Head -> AM.Receive[AM_TS_Head_32];
	App.DataReceive_Head -> AM.Receive[AM_D_Head_32];

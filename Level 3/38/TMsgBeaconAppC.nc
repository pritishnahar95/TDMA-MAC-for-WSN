...
//----------------------------------------------------------------------------------------------------------------------------------------------------------------------
	...
	App.TSReceive -> AM.Receive[AM_TS_38];
	App.DataReceive -> AM.Receive[AM_D_38];
	App.TSReceive_Head -> AM.Receive[AM_TS_Head_38];
	App.DataReceive_Head -> AM.Receive[AM_D_Head_38];

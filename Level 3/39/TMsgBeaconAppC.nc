...
//----------------------------------------------------------------------------------------------------------------------------------------------------------------------
	...
	App.TSReceive -> AM.Receive[AM_TS_39];
	App.DataReceive -> AM.Receive[AM_D_39];
	App.TSReceive_Head -> AM.Receive[AM_TS_Head_39];
	App.DataReceive_Head -> AM.Receive[AM_D_Head_39];

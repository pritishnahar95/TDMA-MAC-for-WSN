...
//----------------------------------------------------------------------------------------------------------------------------------------------------------------------
	...
	App.TSReceive -> AM.Receive[AM_TS_31];
	App.DataReceive -> AM.Receive[AM_D_31];
	App.TSReceive_Head -> AM.Receive[AM_TS_Head_31];
	App.DataReceive_Head -> AM.Receive[AM_D_Head_31];

...
//----------------------------------------------------------------------------------------------------------------------------------------------------------------------
	...
	App.TSReceive -> AM.Receive[AM_TS_37];
	App.DataReceive -> AM.Receive[AM_D_37];
	App.TSReceive_Head -> AM.Receive[AM_TS_Head_37];
	App.DataReceive_Head -> AM.Receive[AM_D_Head_37];

...
//----------------------------------------------------------------------------------------------------------------------------------------------------------------------
	...
	App.TSReceive -> AM.Receive[AM_TS_3A];
	App.DataReceive -> AM.Receive[AM_D_3A];
	App.TSReceive_Head -> AM.Receive[AM_TS_Head_3A];
	App.DataReceive_Head -> AM.Receive[AM_D_Head_3A];
